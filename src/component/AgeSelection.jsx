...
const GradeSelection = ({ onSubmit }) => {
  ...
  return (
    ...
    <div style={{fontSize:"0.9em",lineHeight:"1.5",fontWeight:"bold",marginBottom:"0.5rem",backgroundColor:"#ffffff"}}>{t('imagemapPage.subWindowSubTitle')}</div>
    <div>
      <h2 style={{backgroundColor:"white",fontWeight:"bold"}}>{t('imagemapPage.subWindowTitle')}</h2>
